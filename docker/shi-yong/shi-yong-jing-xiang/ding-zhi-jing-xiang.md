[使用 Dockerfile 定制镜像](https://yeasy.gitbooks.io/docker_practice/content/image/build.html#使用-dockerfile-定制镜像)
...
> 1.[Docker Store](https://store.docker.com/)是发现公共Docker内容，镜像发布和发行软件的新地方[↩](https://yeasy.gitbooks.io/docker_practice/content/image/build.html#reffn_1)
