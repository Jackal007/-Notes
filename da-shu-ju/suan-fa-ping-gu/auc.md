...
* 我避免将precision，recall等评价指标翻译成中文，因为它们可能对应多个中文解释，极易产生混淆。 [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:1)
* 图片来源：[http://en.wikipedia.org/wiki/File:Roccurves.png](http://en.wikipedia.org/wiki/File:Roccurves.png) [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:2)
* 这种映射不一定都是可靠的，即你不一定真的得到了某个样本是正样本的概率。 [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:3)
* 注意这里使用了“Score”，而不是概率，我们暂且可以认为“Score”值就是是正样本的概率。 [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:4)
* Davis, J., & Goadrich, M. \(2006, June\). The relationship between Precision-Recall and ROC curves. In Proceedings of the 23rd international conference on Machine learning \(pp. 233-240\). ACM. [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:5)
* \(Fawcett, 2006\)，Fawcett, T. \(2006\). An introduction to ROC analysis. Pattern recognition letters, 27\(8\), 861-874. [↩](http://alexkong.net/2013/06/introduction-to-auc-and-roc/#fnref:6)
